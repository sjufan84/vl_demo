...
from utils.model_utils import get_bplan_response
...
def bplan_chat_main():
    ...
    initial_greeting = "Welcome to Vocalockr Business Plan Chat!  I'm here to help\
    answer your questions about the business plan.  What would you like to know?"
