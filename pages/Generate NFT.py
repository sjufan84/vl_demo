...
def init_session_variables():
    ...
    session_vars = [
        'nft_demo_page', 'token_id', 'artist_signed', 'nft_metadata'
    ]
    default_values = [
...
def label_interface():
    ...
    metadata = st.session_state.nft_metadata[st.session_state.latest_nft]
