...
def voiceprint_visual():
    ...
    <div style='display: flex; justify-content: center; align-items: center; flex-direction: column;'>
        ...
        fadeIn ease 8s; -ms-animation: fadeIn ease 8s;">One such opportunity we are
        particularly excited about is "Co-writer",
        ...
        <br>
        <br>
        We want to work <i>with</i> artists to select which data is used when creating
        their unique models. We are taking the opposite approach
        to companies whose models are a black box.  In fact, UMG is currently
        <a href="https://www.billboard.com/pro/universal-music-sues-ai-company-using-songs-train-models/">
        suing Anthropic</a>,\
        an AI company with products similar to ChatGPT, for using copyrighted data in their training runs.
        We choose to collaborate, rather than extract, to ensure that the artist is comfortable with
        the process <i>and</i> that those involved
        in the creation of the works used are compensated fairly.
        If a song is used for training, we want to make sure
